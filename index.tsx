...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-800 dark:bg-gray-900 dark:text-gray-200 flex flex-col">
      <Header {...{currentDate, onPrevMonth, onNextMonth, allDays: days, notes, customHolidays, onAddCustomHoliday, onDeleteCustomHoliday}}/>
      <main className="flex-grow container mx-auto p-2 sm:p-4"><Calendar {...{currentDate, daysMap, starredDays, onDayClick, notes}}/></main>
